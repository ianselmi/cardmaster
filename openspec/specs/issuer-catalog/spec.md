...
Catalogo degli emittenti (es. supermercati) usato per riconoscere una carta e mostrarne nome, logo e colore, e per suggerire il formato barcode atteso. In v1 è un seed statico bundle nell'app (offline, nessuna sync); l'associazione di una carta a un emittente è facoltativa.
