# agent-context-doc Specification

## Purpose

File di contesto (`CLAUDE.md`) alla radice del repository che orienta gli agenti AI verso i documenti di progetto esistenti (piano, decisioni, documentazione tecnica) senza duplicarne il contenuto, incluso il promemoria di revisione pre-commit dato che il repository è pubblico.
