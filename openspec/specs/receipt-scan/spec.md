...
Acquisizione di uno scontrino da foto o da un'immagine già presente sul device, riconoscimento del testo **interamente on-device**, estrazione e correzione dei dati di testata (esercente, partita IVA, data, totale), persistenza e storico degli scontrini, con la spesa per esercente e per mese ricavata dalla sola testata.

Non copre le righe dei prodotti, le categorie né alcuna normalizzazione: sono capability successive.
