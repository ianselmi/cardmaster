...
Classificazione delle righe prodotto in **categorie di spesa** a partire da un dizionario locale distribuito con l'applicazione, e **apprendimento locale**: la correzione dell'utente diventa una mappatura persistita che vale per gli scontrini successivi.

Interamente offline e senza segreti; una riga senza corrispondenza resta **senza categoria**, mai attribuita a una categoria di ripiego.
