...
Presentazione delle carte salvate nella pagina principale come griglia di riquadri (tile) colorati, con colore generato in modo deterministico per carta. Definisce il layout e la resa visiva della lista, distinta dallo scaffolding di navigazione (`app-shell`) e dalla creazione carte (`card-capture`).
