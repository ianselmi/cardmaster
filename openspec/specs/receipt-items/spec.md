...
Ricostruzione delle **righe prodotto** di uno scontrino dalla geometria del testo riconosciuto, interpretazione dei casi ricorrenti degli scontrini italiani (quantità esplicita, prodotti a peso, sconti, righe di continuazione), lettura dell'**aliquota IVA** di riga e del riepilogo IVA, **quadratura** delle righe rispetto al totale stampato e correzione manuale.

La quadratura è un segnale, mai una correzione automatica: dice all'utente, scontrino per scontrino, se può fidarsi di quello che legge.
