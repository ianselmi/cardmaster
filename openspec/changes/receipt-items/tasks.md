...
- [ ] 9.2b Ridurre l'appaiamento residuo di due prodotti adiacenti su foto storta: la stima globale dell'inclinazione non basta quando lo scontrino è anche **incurvato** (la pendenza cambia lungo lo scontrino). Prossimo passo naturale: stimare la pendenza **a fasce** invece che una sola per l'intero scontrino
